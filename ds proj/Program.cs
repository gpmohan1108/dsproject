        ...
        static void Main(string[] args)
        {
            ...
            switch (ss)
            {
                case 1:
                    ...
                    string textFile = @"D:\sort and search\studentdata1.txt";
                    ...
                    // Write to file
                    File.WriteAllLines("D:\\sort and search\\studentdata2.txt", sorted2.Select(x => x.Key + "," + x.Value).ToArray());
                    ...
                    // Write to file
                    File.WriteAllLines("D:\\sort and search\\studentdata3.txt", sorted4.Select(x => x.Key + "," + x.Value).ToArray());
                ...
                case 2:
                    ...
                    string[] words = File.ReadAllText("D:\\sort and search\\studentdata1.txt").Split(' ');
